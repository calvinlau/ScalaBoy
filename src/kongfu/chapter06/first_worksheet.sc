package kongfu.chapter06

import kongfu.chapter04.ChecksumAccumulator.calculate

object Fall {

  calculate("s")                                        //> res0: Int = -115

  implicit def intToRational(i: Int) = new Rational(i)  //> intToRational: (i: Int)scala2e.chapter06.Rational
  println("""|Welcome to Ultamix 3000.                  //> Welcome to Ultamix 3000.
             |Type "HELP" for help.""".stripMargin)     //| Type "HELP" for help.
  ...
  val rn = randomNums.filter((x: Int) => x % 2 == 0)    //> rn  : List[Int] = List(2, -2, 72)
